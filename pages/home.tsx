...
const stories = [
  ...
  },
  {
    ...
    timeAgo: "4h ago",
    content:
      "Just finished the community cleanup project. So proud of our neighborhood coming together!",
    hasImage: false,
    likes: 18,
    liked: false,
    comments: 5,
...
export default function Home() {
  ...
  const [selectedTab, setSelectedTab] = useState<"thisYear" | "memories">(
    "thisYear",
  );
    ...
    <div className="h-[100dvh] flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex flex-col flex-1">
          {/* Main Content */}
          <div className="flex-1 bg-gradient-to-r from-blue-100 to-purple-100 overflow-y-auto">
            {/* Tab Navigation */}
              ...
              <div className="lg:col-span-8 lg:col-start-3 space-y-6">
                ...
                <section>
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg md:text-xl lg:text-xl font-bold text-gray-800">
                      Next Event
                    </h2>
                    <button
                ...
                {/* Stories Section */}
                <section>
                  <h2 className="text-lg md:text-xl lg:text-xl font-bold text-gray-800 mb-4">
                    Stories
                  </h2>
                      ...
                      >
                        <CardContent className="p-4 md:p-5 lg:p-6">
                          ...
                          <div className="flex items-start space-x-3 mb-3">
                            <div
                              className={`w-10 h-10 md:w-11 md:h-11 lg:w-12 lg:h-12 bg-gradient-to-br ${story.avatarGradient} rounded-full flex items-center justify-center text-white font-bold text-sm md:text-base lg:text-base flex-shrink-0`}
                            >
                              {story.initials}
                            </div>
                            <div className="flex-1 min-w-0">
                              <h4 className="font-semibold text-gray-800 text-sm md:text-base lg:text-base">
                                {story.user}
                              </h4>
                          ...
                          {story.hasImage && (
                            <div className="mb-4 rounded-xl overflow-hidden">
                              ...
                              <div className="h-48 md:h-56 lg:h-64 bg-gradient-to-br from-yellow-300 via-pink-300 to-purple-300 relative flex items-center justify-center">
                                ...
                                <div className="text-4xl md:text-5xl lg:text-5xl">
                                  🎉
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            >
                              <Heart
                                className={`w-5 h-5 md:w-6 md:h-6 lg:w-6 lg:h-6 ${story.liked ? "fill-current" : ""}`}
                              />
