    ...
    <div className="h-[100dvh] flex flex-col">
      ...
      <header className="bg-white border-b border-gray-200 py-2 px-4 flex items-center justify-between shadow-sm z-20 relative">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full text-sm font-medium hover:from-purple-600 hover:to-pink-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-200">
            UPGRADE
          </button>
        </div>
      </header>
